...
func newContractDeps(t *testing.T) *contractDeps {
	...
	adminService := service.NewAdminService(userRepo, groupRepo, &accountRepo, proxyRepo, apiKeyRepo, redeemRepo, nil, nil, apiKeyService, nil, nil, nil, nil, nil, nil, nil, nil, nil)
