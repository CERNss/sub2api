...
// fork: trimmed to the lineup the gateway actually serves (gpt-5.4, gpt-5.2,
// gpt-image-1 and gpt-image-1.5 dropped, 2026-09-05). The first entry stays
// gpt-5.6-sol — upstream pins it as the account-test default.
