  ...
  admin: {
    ...
    settings: {
      ...
      oidc: {
        ...
        requireEmailVerified: '校验上游邮箱',
        requireEmailVerifiedHint: '使用 OIDC 的 email_verified。',
        requireLocalEmailVerification: '本地建号需邮箱验证码',
        requireLocalEmailVerificationHint: '仅用于 OIDC 本地建号。',
