  ...
  admin: {
    ...
    settings: {
      ...
      oidc: {
        ...
        requireEmailVerified: 'Check Upstream Email',
        requireEmailVerifiedHint: 'Use the OIDC email_verified claim.',
        requireLocalEmailVerification: 'Require Site Email Code',
        requireLocalEmailVerificationHint: 'Only for OIDC local signup.',
